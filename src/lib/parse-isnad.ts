...
// AKRONIM tahdith (rujuk Kamus al-Ghouri): نا/ثنا/دثنا/دنا = حدثنا · انا/ابنا =
// اخبرنا · دثني = حدثني — BUKAN nama perawi ("نا هشيم بن بشير" → هشيم).
// Lookbehind (?<![ء-ي]) elak terpotong dalam kata (سمعنا/فلانا).
const CONNECT = /(?:وحدثناه|وحدثنا|وحدثني|واخبرناه|واخبرنا|واخبرني|فحدثناه|فحدثنا|فحدثني|حدثناه|حدثنا|حدثني|حدثهم|حدثه|اخبرناه|اخبرنا|اخبرني|اخبرهم|انبانا|انباني|(?<![ء-ي])دثنا|(?<![ء-ي])دثني|(?<![ء-ي])دنا |(?<![ء-ي])ثنا|(?<![ء-ي])ابنا |(?<![ء-ي])انا |(?<![ء-ي])نا |(?<![ء-ي])ان |سمعته|سمعت|سمع |عن |قال لنا|قال لي|كتب الي|قرات علي|قري علي|روي عن|رواه عن|قالوا|قالا|قالت|قال)/g;
